...
CREATE TABLE train_project_publish (
  ...
  process_weight DECIMAL(5,4) DEFAULT NULL COMMENT '过程得分权重(0-1)',
  team_weight DECIMAL(5,4) DEFAULT NULL COMMENT '团队协作得分权重(0-1)',
  final_weight DECIMAL(5,4) DEFAULT NULL COMMENT '答辩得分权重(0-1)',
  start_date DATE,
  end_date DATE,
  status TINYINT NOT NULL DEFAULT 1,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
